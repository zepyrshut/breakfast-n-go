...
func getRoutes() http.Handler {
	...
	mux.Get("/terrace", Repo.Terrace)
	mux.Get("/spa", Repo.Spa)

	mux.Get("/availability", Repo.Availability)
	mux.Post("/availability", Repo.DoPostAvailability)
...
func CreateTestTemplateCache() (map[string]*template.Template, error) {
	...
	//  Generate a map with key as string and value as pointer of templates type.
	...
	// Iterate map and add pages to the map. Key as name, and value as page.
